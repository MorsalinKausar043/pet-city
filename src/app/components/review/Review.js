...
const Review = () => {
  const reviewData = [{id:1},{id:2}];
  return (
    <>
      <main
        className={`bg-slate-50 w-full h-full flex flex-col justify-center items-center`}
      >
        <section className="px-2 md:px-10 lg:px-20 container py-10 md:py-16 mx-auto">
          {/* title  */}
          <SectionTitle title="WHAT CLIENTS SAY" body="RECENT REVIEWS" />
          <div className="flex flex-wrap -m-4">
            {reviewData.map((val) => (
              <div key={val.id} className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-100 rounded border-2 border-lime-500 shadow-xl shadow-lime-500/20">
                  <div className="p-8">
                    <svg
                  ...
                  <div className="w-full h-auto bg-lime-500 p-2">
                    <a className="inline-flex items-center">
                      <Image
                        ...
                        className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center border-[2px] border-lime-600"
                      />
